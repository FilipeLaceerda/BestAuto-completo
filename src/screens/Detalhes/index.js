      ...
      .then(resultado => {
        if (resultado.alive === 'yes') {
          ...
          this.setState(
            ...
            () => {
              Toast.show(
                'Não é possível comentar sobre o produto agora :(',
                Toast.LONG,
              );
            },
          );
    ...
    gostar(usuario, feedId)
      .then(resultado => {
        if (resultado.situacao === 'ok') {
          ...
          Toast.show(
            'Ocorreu um erro nessa operação. Tente de novo mais tarde!',
            Toast.LONG,
          );
        }
      })
        ...
        <>
          ...
          <CardView cardElevation={2} cornerRadius={0}>
            ...
            <View style={{padding: 8}}>
              ...
              <TouchableOpacity>
                <Button
                  title="Deseja marcar um horário??"
                  onPress={() =>
