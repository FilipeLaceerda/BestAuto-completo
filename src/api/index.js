const FEEDS_URL = "http://10.0.0.117:5002/"
const EMPRESAS_URL = "http://10.0.0.117:5001/"
const COMENTARIOS_URL = "http://10.0.0.117:5004/"
const AGENDAMENTO_URL = "http://10.0.0.117:5005/"
const LIKES_URL = "http://10.0.0.117:5003/"
const ARQUIVOS_URL = "http://10.0.0.117:8000/"
...
export const agendamentoAlive = () => {
    return acessarUrl(AGENDAMENTO_URL + "isAlive")
}

export const adicionarAgendamento = async (usuario, data) => {
    let promise = null;
        promise = acessarUrl(AGENDAMENTO_URL + "adicionar/"  + encodeURIComponent(usuario.name)  + "/" + encodeURIComponent(data));
    return promise;
}